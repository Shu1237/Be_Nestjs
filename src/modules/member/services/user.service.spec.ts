...
describe('UserService', () => {
  ...
  describe('4.softDelete', () => {
    it('✅ 4.1 should soft delete user successfully', async () => {
      const mockUser = {
        id: '1',
        username: 'testuser',
        is_deleted: false,
    ...
    it('✅ 4.4 should not delete already deleted user', async () => {
      const mockUser = {
        id: '1',
        username: 'testuser',
        is_deleted: true,
  ...
  describe('5.restore', () => {
    it('✅ 5.1 should restore user successfully', async () => {
      const mockUser = {
        id: '1',
        username: 'testuser',
        is_deleted: true,
